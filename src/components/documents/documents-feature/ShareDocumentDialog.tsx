...
const ShareDocumentDialog = ({ open, onOpenChange, document }: ShareDocumentDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl h-[600px] bg-white border border-gray-200 p-0 flex flex-col">
        <DialogHeader className="flex-shrink-0 border-b border-gray-100 p-6 pb-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 min-h-0">
          <TabsList className="flex-shrink-0 grid w-full grid-cols-3 bg-gray-50 mx-6 mt-4 mb-0 rounded-md">
            <TabsTrigger 
              value="departments" 
          ...
          <div className="flex-shrink-0 flex justify-end gap-3 p-6 pt-4 border-t border-gray-100 bg-white">
            <Button
              variant="outline"
