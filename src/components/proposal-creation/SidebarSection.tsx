  ...
  const comments = [
    {
      ...
      time: "2 hours ago",
      content:
        "Lorem ipsum dolor sit amet consetur. Blan dit in placerat morbi venenatis.",
    },
    {
      id: 2,
      author: "Jane Doe",
    ...
    <aside className="w-[370px] h-[728px] p-6">
      <div className="flex flex-col w-full items-start gap-4">
        ...
        <div className="flex flex-col items-start gap-4 w-full">
          {comments.map((comment) => (
            <Card
              key={comment.id}
              className="w-full shadow-[0px_4px_16px_#eae2fd]"
            >
              <CardContent className="p-0">
                <div className="flex flex-col items-start gap-1 p-4">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <span className="text-[#383839a8] text-xs">
                      {comment.time}
                    </span>
                  </div>
      ...
      <div className="flex flex-col w-full items-start gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <h3 className="font-medium text-[#383839] text-sm">
            Version History
          </h3>
        </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between w-full">
                  <div className="flex flex-col gap-1">
                    <h4 className="font-medium text-[#383839] text-sm">
                      {version.version}
                    </h4>
                    <div className="flex items-center gap-2">
