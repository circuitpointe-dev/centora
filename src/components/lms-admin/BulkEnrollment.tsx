        ...
        {activeStep === 'preview' && (
          <>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700">Add learners to catalog visibility</span>
                </label>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <label className="text-sm font-medium text-gray-900">Uploaded file</label>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {uploadedLearners.map((learner) => (
                        <tr key={learner.id} className="border-b border-gray-100">
                          <td className="py-3 px-4 text-sm text-gray-900">{learner.name}</td>
                          <td className="py-3 px-4 text-sm text-gray-600">{learner.email}</td>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative" ref={reminderDropdownRef}>
                    <button
                      ...
                      className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 bg-white"
                    >
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700">Send enrollment confirmation</span>
                </label>
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700">Send calendar invite</span>
                </label>
              </div>
            </div>
