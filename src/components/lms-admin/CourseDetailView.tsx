...
const CourseDetailView = () => {
  ...
  return (
    <div className="p-6 space-y-6 bg-background min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-muted rounded-xl p-6 border border-border shadow-sm">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-3xl font-bold text-foreground mb-1">548</p>
            <p className="text-sm font-medium text-muted-foreground">Enrollment trends</p>
          </div>
        </div>
        ...
        <div className="bg-muted rounded-xl p-6 border border-border shadow-sm">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-3xl font-bold text-foreground mb-1">22</p>
            <p className="text-sm font-medium text-muted-foreground">Issued certificate</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm p-6">
        <h3 className="text-lg font-bold text-foreground mb-4">Enrollments & access</h3>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-3 px-4 font-medium text-foreground">Learner</th>
                <th className="text-left py-3 px-4 font-medium text-foreground">Date assigned</th>
            ...
            <tbody>
              {learners.map((learner, index) => (
                <tr key={index} className="border-b border-border">
                  ...
                  <td className="py-3 px-4 text-sm text-muted-foreground">{learner.dateAssigned}</td>
                  <td className="py-3 px-4">
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm p-6">
        <h3 className="text-lg font-bold text-foreground mb-4">Compliance & Accessibility</h3>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <CheckCircle className="h-5 w-5 text-purple-600" />
              <span className="text-sm text-foreground">Passed accessibility scan</span>
            </div>
          ...
          <div className="flex items-center space-x-3">
            <CheckCircle className="h-5 w-5 text-purple-600" />
            <span className="text-sm text-foreground">SCORM conferment</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm p-6">
        <h3 className="text-lg font-bold text-foreground mb-4">Linked Resourced</h3>
        <div className="space-y-3">
