          ...
          <CollapsibleContent>
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-foreground">000257</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-foreground">Level 5</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <CollapsibleContent>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-foreground">3/5 completed</span>
              </div>
            </CardContent>
          </CollapsibleContent>
        </Collapsible>
        ...
        <Collapsible open={leaveAttendanceOpen} onOpenChange={setLeaveAttendanceOpen}>
          ...
          <CollapsibleContent>
            <CardContent className="space-y-6">
              ...
              <div>
                <h4 className="text-sm font-medium text-foreground mb-3">My leave requests</h4>
                    ...
                    <tbody>
                      {leaveRequests.map((request) => (
                        <tr key={request.id} className="border-b border-border">
                          <td className="py-2 px-3 text-xs text-foreground">{request.id}</td>
                          <td className="py-2 px-3 text-xs text-muted-foreground">{request.type}</td>
                          <td className="py-2 px-3 text-xs text-muted-foreground">{request.dateCreated}</td>
                          <td className="py-2 px-3 text-xs text-muted-foreground">{request.leaveRange}</td>
                          <td className="py-2 px-3 text-xs text-muted-foreground">{request.duration}</td>
                          <td className="py-2 px-3 text-xs text-muted-foreground">{request.approver}</td>
          ...
          <CollapsibleContent>
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-foreground">8/10</span>
              </div>
              <div className="flex items-center space-x-3">
                <Calendar className="h-4 w-4 text-muted-foreground" />
                <span className="text-sm text-muted-foreground">Expiring document:</span>
                <span className="text-sm text-foreground">Work permit - </span>
        ...
        <Collapsible open={activityLogOpen} onOpenChange={setActivityLogOpen}>
          ...
          <CollapsibleContent>
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Login at 03:00 pm, Jul 20, 2025</span>
                <span className="text-xs text-muted-foreground">5 mins ago</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Leave approved at May 12, 2025</span>
                <span className="text-xs text-muted-foreground">10 mins ago</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Training "Emotional intelligence" at Jul 21, 2025</span>
                <span className="text-xs text-muted-foreground">03:00 pm</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Login at Jul 22, 2025</span>
