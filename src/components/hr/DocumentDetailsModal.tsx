...
const DocumentDetailsModal: React.FC<DocumentDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-card rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-foreground">Document Details</h2>
            <p className="text-sm text-muted-foreground mt-1">{document.owner} • {document.type}</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
            ...
            <div className="space-y-6 mt-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <span className="text-sm font-medium text-muted-foreground">Document File</span>
                    ...
                    <div className="border border-border rounded-lg bg-muted/50 min-h-[400px] flex items-center justify-center">
                      <div className="text-center space-y-4">
                        <FileText className="w-16 h-16 text-muted-foreground mx-auto" />
                        <div>
                          <p className="text-lg font-medium text-foreground">{document.type}</p>
                          <p className="text-sm text-muted-foreground">Document preview will be displayed here</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm font-semibold text-foreground mt-1">PDF</p>
                      </div>
                      <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-foreground mt-1">{document.owner}</p>
                      </div>
                    </div>
                  </div>
                </>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-foreground mt-1">{document.type}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Country</label>
                        <p className="text-sm text-foreground mt-1">{document.country}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Document number</label>
                        <p className="text-sm text-foreground mt-1">{document.number}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Owner</label>
                        <p className="text-sm text-foreground mt-1">{document.owner}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Department</label>
                        <p className="text-sm text-foreground mt-1">{document.department}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Issue date</label>
                        <p className="text-sm text-foreground mt-1">Jul 30, 2025</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-muted-foreground">Expiry date</label>
                        <p className="text-sm font-semibold text-red-600 mt-1">{document.expiry}</p>
              ...
              {activeTab === 'history' && (
                <div className="space-y-8">
                    ...
                    <div className="relative">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="relative flex items-start space-x-4">
                          <div className="flex-shrink-0 w-8 h-8 bg-foreground rounded-full flex items-center justify-center relative z-10">
                            <div className="w-3 h-3 bg-card rounded-full"></div>
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <p className="text-sm font-medium text-foreground">Document Uploaded</p>
                              <p className="text-sm text-muted-foreground">2024-05-14</p>
                            </div>
                            <p className="text-sm text-muted-foreground mt-1">Initial document upload by HR team</p>
                          </div>
                        </div>
                        ...
                        <div className="relative flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <p className="text-sm font-medium text-foreground">First Reminder Sent</p>
                              <p className="text-sm text-muted-foreground">2025-03-15</p>
                            </div>
                            <p className="text-sm text-muted-foreground mt-1">90-day expiry notification sent to Jane Doe</p>
                          </div>
                        </div>
                        ...
                        <div className="relative flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">30-day expiry warning sent</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Access Log Section */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-foreground">Access log</h3>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-muted/50 rounded-lg p-4 flex items-center justify-between">
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground">Viewed by HR Admin</p>
                      ...
                      <div className="bg-muted/50 rounded-lg p-4 flex items-center justify-between">
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground">Downloaded by Jane Doe</p>
                          <p className="text-sm text-muted-foreground">Employee self-service</p>
                        </div>
        ...
        <div className="flex justify-between items-center p-6 border-t bg-muted/50">
          ...
          <div className="flex space-x-3">
            <Button
              ...
              className="bg-foreground text-background hover:bg-muted-foreground border-foreground"
            >
