    ...
    <div className="bg-card border border-border rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
      <div className="flex items-center space-x-6">
        ...
        <div className="flex-1">
          <div className="text-xl font-semibold text-card-foreground mb-1">
            {session.title}
          </div>
          <div className="text-sm text-muted-foreground">
...
const MySessionCard: React.FC<MySessionCardProps> = ({ session }) => {
  ...
  const getButtonContent = () => {
    ...
    return (
      <button className="bg-primary hover:bg-primary/90 text-white py-2 px-6 rounded-md text-sm font-medium transition-colors duration-200">
        Join session
      </button>
    );
  };
    ...
    <div className={`bg-card border rounded-lg p-6 hover:shadow-md transition-shadow duration-200 ${
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className={`w-px h-12 ${
          isPastSession ? 'bg-muted' : 'bg-border'
        }`}></div>
    ...
    <div className="bg-card border border-border rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
      <div className="flex items-center space-x-6">
        ...
        <div className="flex-shrink-0 flex flex-col space-y-3">
          <button className="bg-primary hover:bg-primary/90 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-200 flex items-center space-x-2">
            <Play size={16} />
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-card border border-border rounded-md px-4 py-2 pr-8 text-sm focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none"
                  >
          ...
          {activeTab === 'calendar' && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative">
                  <select className="appearance-none bg-card border border-border rounded-md px-4 py-2 pr-8 text-sm focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none">
              ...
              <div className="bg-card border border-border rounded-lg overflow-hidden max-h-96 overflow-y-auto">
                ...
                <div className="grid grid-cols-6 border-b border-border sticky top-0 bg-card z-10">
                  <div className="p-4 border-r border-border bg-accent"></div>
                  {days.map((day) => (
                    <div key={day.day} className="p-4 border-r border-border bg-accent text-center">
