...
const CertificateModal: React.FC<CertificateModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-[650px] max-h-[90vh] overflow-hidden">
        {/* Modal Header */}
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-center space-x-4 mt-6">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-medium transition-colors text-sm"
            >
              <Download size={16} />
              <span>Download</span>
            </button>
