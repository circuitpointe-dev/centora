...
-- 3. GRANTS MODULE: Add sample grants (using correct column names)
INSERT INTO grants (org_id, grant_name, donor_name, amount, currency, status, start_date, end_date, description, program_area, region, created_by)
SELECT 
  'c21e6282-30c3-4aa9-b646-339007d22a4f'::uuid,
