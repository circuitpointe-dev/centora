...
INSERT INTO grant_reports (
  ...
  (
    'a1111113-1111-1111-1111-111111111111',
    '11111111-1111-1111-1111-111111111111',
    'quarterly',
    '2024-10-31',
    'overdue',
  ...
  (
    'a1111114-1111-1111-1111-111111111111',
    '11111111-1111-1111-1111-111111111111',
    'annual',
    '2025-01-31',
    'upcoming',
  ...
  (
    'a2222221-2222-2222-2222-222222222222',
    '22222222-2222-2222-2222-222222222222',
    'quarterly',
    '2024-06-30',
    'submitted',
  ...
  (
    'a2222223-2222-2222-2222-222222222222',
    '22222222-2222-2222-2222-222222222222',
    'financial',
    '2024-12-31',
    'upcoming',
  ...
  (
    'a3333331-3333-3333-3333-333333333333',
    '33333333-3333-3333-3333-333333333333',
    'quarterly',
    '2024-09-30',
    'submitted',
  ...
  (
    'a3333332-3333-3333-3333-333333333333',
    '33333333-3333-3333-3333-333333333333',
    'narrative',
    '2024-12-31',
    'in_progress',
  ...
  (
    'a4444441-4444-4444-4444-444444444444',
    '44444444-4444-4444-4444-444444444444',
    'quarterly',
    '2024-12-31',
    'upcoming',
  ...
  (
    'a4444442-4444-4444-4444-444444444444',
    '44444444-4444-4444-4444-444444444444',
    'financial',
    '2025-03-31',
    'upcoming',
