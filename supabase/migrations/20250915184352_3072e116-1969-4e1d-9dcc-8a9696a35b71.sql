...
BEGIN
  ...
  IF user_profile.id IS NOT NULL THEN
    ...
    LOOP
      ...
      VALUES (user_profile.id, user_profile.org_id, module_key, true, user_profile.id)
      ...
      VALUES 
        (user_profile.id, user_profile.org_id, module_key, 'create', ARRAY['create', 'read', 'update', 'delete'], user_profile.id),
        (user_profile.id, user_profile.org_id, module_key, 'read', ARRAY['create', 'read', 'update', 'delete'], user_profile.id),
        (user_profile.id, user_profile.org_id, module_key, 'update', ARRAY['create', 'read', 'update', 'delete'], user_profile.id),
        (user_profile.id, user_profile.org_id, module_key, 'delete', ARRAY['create', 'read', 'update', 'delete'], user_profile.id)
