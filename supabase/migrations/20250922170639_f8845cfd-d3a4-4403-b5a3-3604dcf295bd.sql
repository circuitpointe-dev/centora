-- Add sample data for your 4 modules using only draft status
...
-- Documents Module - Sample Documents using only draft status
INSERT INTO documents (org_id, title, description, category, status, file_name, file_path, mime_type, file_size, created_by)
VALUES 
  ('c21e6282-30c3-4aa9-b646-339007d22a4f', 'Organization Policy Manual', 'Comprehensive policy and procedures manual', 'uncategorized', 'draft', 'policy_manual_2024.pdf', 'policies/policy_manual_2024.pdf', 'application/pdf', 2048000, '1d0a3763-f207-4234-a0d2-a392b7e4504d'),
  ('c21e6282-30c3-4aa9-b646-339007d22a4f', 'Grant Application Template', 'Standard template for grant applications', 'template', 'draft', 'grant_application_template.docx', 'templates/grant_application_template.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 512000, '1d0a3763-f207-4234-a0d2-a392b7e4504d'),
  ('c21e6282-30c3-4aa9-b646-339007d22a4f', 'Financial Report Q3 2024', 'Third quarter financial performance report', 'uncategorized', 'draft', 'financial_report_q3_2024.pdf', 'reports/financial_report_q3_2024.pdf', 'application/pdf', 1024000, '1d0a3763-f207-4234-a0d2-a392b7e4504d'),
