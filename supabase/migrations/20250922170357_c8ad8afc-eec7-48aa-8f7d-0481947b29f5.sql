-- Add sample data for your 4 modules using correct enum values
...
-- Documents Module - Sample Documents using valid enum values
INSERT INTO documents (org_id, title, description, category, status, file_name, file_path, mime_type, file_size, created_by)
VALUES 
  ('c21e6282-30c3-4aa9-b646-339007d22a4f', 'Organization Policy Manual', 'Comprehensive policy and procedures manual', 'contract', 'published', 'policy_manual_2024.pdf', 'policies/policy_manual_2024.pdf', 'application/pdf', 2048000, '1d0a3763-f207-4234-a0d2-a392b7e4504d'),
